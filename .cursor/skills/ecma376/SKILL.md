---
name: ecma376
description: ECMA-376 Office Open XML 规范查询。查找 .xlsx/.docx/.pptx 中 XML 元素、属性、枚举值的标准定义与结构。当遇到 SpreadsheetML、WordprocessingML、PresentationML、DrawingML、OPC 包格式问题，或需要确认 XML 元素/属性/schema 结构时使用。
---
